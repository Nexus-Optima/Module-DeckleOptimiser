...
def get_optimised_knives(client_metadata, data):
    plan_df, customer_df, metric_df = common_optimisation_logic(data, get_optimised_knives_deckle)
...
def get_optimised_wastage(client_metadata, data):
    plan_df, customer_df, metric_df = common_optimisation_logic(data, get_optimised_wastage_deckle)
