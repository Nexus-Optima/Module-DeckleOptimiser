...
def customer_table(final_dict, df):
    ...
    customer_df[CustomerTable.target_quantity] = df[OrderDetails.so_qty].round(0).astype(int)
    ...
    customer_df[CustomerTable.production_quantity] = (customer_df[CustomerTable.actual_rolls] * customer_df[CustomerTable.width] * df[OrderDetails.product_thickness] * df[OrderDetails.product_length] * 0.91/ 1000000) + df[OrderDetails.current_stock]
